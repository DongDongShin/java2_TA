...
public class CommandWords {
	...
	public String showAll(){
		...
		sb.append(validCommands[0]+" ");
		sb.append(validCommands[1]+" ");
		sb.append(validCommands[2]+" ");
		sb.append(validCommands[3]+" ");
		sb.append(validCommands[4]+" ");
		sb.append(validCommands[5]+"\n");
		return sb.toString();
	}
