...
public class Game {
    ...
    private void createRooms() {
         ...
         */
         ...
         dongBang.setItem(new Item("portion","Increase strength 5 levels",5));
         dongBang.setItem(new Item("book","AI tech book",5));
    ...
    private boolean processCommand(Command command) {
        ...
        if (commandWord.equals("help")) {
            ...
            if(command.hasSecondWord()){
                System.out.println("You can fo back one step only");
    ...
    private void back(){
        ...
        if(recentRoom!=null&&currentRoom!=recentRoom){//다를 경우에
    ...
    private void printHelp() {
        ...
        System.out.print(parser.getCommandList());
    }
    ...
    private void goRoom(Command command) {
        ...
        if (nextRoom == null) {
            ...
            recentRoom = currentRoom;//방을 받아와야지.
