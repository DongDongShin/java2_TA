...
public class Player {
	...
	/**
	 * 선수가 가지고 있는 아이템들의 list를 반환한다. 단, 반환되는 list는 수정할 수 없는 list이다.
	 * 
	...
	/**
	 * 주어진 방향으로 옮겨간다. 그 방향으로 출구가 없으면 현재 위치에 머문다.
	 * 
	...
	/**
	 * 이전 방으로 돌아간다. 처음에 있던 방에 왔으므로 더 이상 돌아갈 수가 없으면 아무 일도 하지 않는다.
	 */
	public void back() {
	 ...
	 * 
	 * @return 이 Player가 들 수 있는 아이템의 최대 무게.
	 */
